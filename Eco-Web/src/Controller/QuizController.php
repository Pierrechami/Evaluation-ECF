...
{
    /**
     * @Route("/show/{id}", name="app_quiz_index", methods={"GET", "POST"})
     */
    public function index(QuizRepository $quizRepository, $id): Response
    {
        ...
        return $this->render('quiz/index.html.twig', [
            'quizzes' => $quizRepository->findBy(['section' => ['id' => $id]]),
        ]);
    }
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager , $id, SectionRepository $sectionRepository): Response
    {
