 ...
 */
class Version20230712132307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(60) DEFAULT NULL, name VARCHAR(60) DEFAULT NULL, pseudo VARCHAR(60) DEFAULT NULL, profile_picture VARCHAR(255) DEFAULT NULL, description_specialty VARCHAR(255) DEFAULT NULL, is_accepted TINYINT(1) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
