 ...
 */
final class Version20220405095342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD question1 VARCHAR(255) NOT NULL, ADD response1 TINYINT(1) NOT NULL, ADD not_good1 VARCHAR(255) DEFAULT NULL, ADD question2 VARCHAR(255) NOT NULL, ADD response2 TINYINT(1) NOT NULL, ADD not_good2 VARCHAR(255) DEFAULT NULL, ADD question3 VARCHAR(255) NOT NULL, ADD response3 TINYINT(1) NOT NULL, ADD not_good3 VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz DROP question1, DROP response1, DROP not_good1, DROP question2, DROP response2, DROP not_good2, DROP question3, DROP response3, DROP not_good3');
