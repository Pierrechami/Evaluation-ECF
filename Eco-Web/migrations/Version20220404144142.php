 ...
 */
final class Version20220404144142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD section_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz DROP section_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE good_reponse good_reponse VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
