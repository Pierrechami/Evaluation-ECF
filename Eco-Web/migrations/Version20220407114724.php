 ...
 */
final class Version20220407114724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE progress CHANGE lesson_finish lesson_finished TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE progress CHANGE lesson_finished lesson_finish TINYINT(1) DEFAULT NULL');
